    ...
    <div class="playback">
        ...
        <div class="playback_snap_you">
            <div id="Fullscreen">
                        ...
                        <div 
							...
							<div class="h5controls" style="display:none padding:0px;">
								<div style="display: flex;justify-content: flex-end;">
									<button :id="'rtchvideo'+r+c" class="iconfont icon-bofang open_button rotate" @click="open_liveplay_butt" style="font-size:12px;line-height: 14px;"></button>
				...
				<div style="width:82%;height:14px;position:absolute;display:flex;justify-content: space-between;padding:0 5px;">
                        ...
                        <div class="tab" :id="'tab'+r+c" >
                            ...
                            <div style="width:100%;display: flex;justify-content: space-between;">
                                ...
                                <div class="function_butt" style="display: flex;align-items:center;">
									...
									<button v-if="r=='1'&&c=='3'" type="button" :class="icon4" @click="resume()" class="button_resume"></button>
                                    <button v-if="r=='2'&&c=='3'" type="button" :class="icon5" @click="resume()" class="button_resume"></button>
                                    <button v-if="r=='3'&&c=='1'" type="button" :class="icon6" @click="resume()" class="button_resume"></button>
                                    <button v-if="r=='3'&&c=='2'" type="button" :class="icon7" @click="resume()" class="button_resume"></button>
                                    <button v-if="r=='3'&&c=='3'" type="button" :class="icon8" @click="resume()" class="button_resume"></button>
...
export default {
    ...
    data() {
        return {
			...
			icon4:"iconfont icon-bofang",//暂停图片
			icon5:"iconfont icon-bofang",//暂停图片
			icon6:"iconfont icon-bofang",//暂停图片
			icon7:"iconfont icon-bofang",//暂停图片
			icon8:"iconfont icon-bofang",//暂停图片
    ...
    methods:{
			...
			open_liveplay_butt(){
				if ($("#"+this.rtcid).attr("class")=="iconfont icon-bofang open_button rotate") {
					...
					this.$nextTick(()=>{
						$("#"+this.rtcid).parent().parent('.h5controls').css('background-size', '165px 35px');
					})
				}else{
					...
					_this.$http.get(url).then(result=>{
						...
						if(_this.selectRow=="1"&&_this.selectCol=="1"){
							...
							_this.$nextTick (()=>{
								...
								//return false;
								_this.v2.connect();
								_this.icon1="iconfont icon-zantingtingzhi";
								setTimeout(()=>{
									_this.timeSpeed();
								},1000)
							})
							...
							_this.$nextTick (()=>{
								...
								//return false;
								_this.v3.connect();
								_this.icon2="iconfont icon-zantingtingzhi";
								setTimeout(()=>{
									_this.timeSpeed();
								},1000)
							})
							...
							_this.$nextTick (()=>{
								...
								//return false;
								_this.v4.connect();
								_this.icon3="iconfont icon-zantingtingzhi";
								setTimeout(()=>{
									_this.timeSpeed();
								},1000)
							})
							...
							_this.$nextTick (()=>{
								...
								//return false;
								_this.v5.connect();
								_this.icon4="iconfont icon-zantingtingzhi";
							})
							...
							_this.$nextTick (()=>{
								...
								//return false;
								_this.v6.connect();
								_this.icon5="iconfont icon-zantingtingzhi";
							})
							...
							_this.$nextTick (()=>{
								...
								//return false;
								_this.v7.connect();
								_this.icon6="iconfont icon-zantingtingzhi";
							})
							...
							_this.$nextTick (()=>{
								...
								//return false;
								_this.v8.connect();
								_this.icon7="iconfont icon-zantingtingzhi";
							})
							...
							_this.$nextTick (()=>{
								...
								//return false;
								_this.v9.connect();
								_this.icon8="iconfont icon-zantingtingzhi";
							})
						}
					})
		...
		resume(){
			...
			var strart4=this.icon4;
			var strart5=this.icon5;
			var strart6=this.icon6;
			var strart7=this.icon7;
			var strart8=this.icon8;
			console.log(strart);
			if(this.selectRow=="1"&&this.selectCol=="1"){
				if(this.v1 != undefined){
				...
				if(this.v5 != undefined){
					//iconfont icon-zantingtingzhi  iconfont icon-bofang
					if(strart4=="iconfont icon-zantingtingzhi"){
						this.icon4="iconfont icon-bofang";
						console.log(this.icon);
						this.v5.pause();
					}
					if(strart4=="iconfont icon-bofang"){
						this.icon4="iconfont icon-zantingtingzhi";
						console.log(this.icon);
						this.v5.resume();
					}
				}
				...
				if(this.v6 != undefined){
					//iconfont icon-zantingtingzhi  iconfont icon-bofang
					if(strart5=="iconfont icon-zantingtingzhi"){
						this.icon5="iconfont icon-bofang";
						console.log(this.icon);
						this.v6.pause();
					}
					if(strart5=="iconfont icon-bofang"){
						this.icon5="iconfont icon-zantingtingzhi";
						console.log(this.icon);
						this.v6.resume();
					}
				}
				...
				if(this.v7 != undefined){
					//iconfont icon-zantingtingzhi  iconfont icon-bofang
					if(strart6=="iconfont icon-zantingtingzhi"){
						this.icon6="iconfont icon-bofang";
						console.log(this.icon);
						this.v7.pause();
					}
					if(strart6=="iconfont icon-bofang"){
						this.icon6="iconfont icon-zantingtingzhi";
						console.log(this.icon);
						this.v7.resume();
					}
				}
				...
				if(this.v8 != undefined){
					//iconfont icon-zantingtingzhi  iconfont icon-bofang
					if(strart7=="iconfont icon-zantingtingzhi"){
						this.icon7="iconfont icon-bofang";
						console.log(this.icon);
						this.v8.pause();
					}
					if(strart7=="iconfont icon-bofang"){
						this.icon7="iconfont icon-zantingtingzhi";
						console.log(this.icon);
						this.v8.resume();
					}
				}
				...
				if(this.v9 != undefined){
					//iconfont icon-zantingtingzhi  iconfont icon-bofang
					if(strart8=="iconfont icon-zantingtingzhi"){
						this.icon8="iconfont icon-bofang";
						console.log(this.icon);
						this.v9.pause();
					}
					if(strart8=="iconfont icon-bofang"){
						this.icon8="iconfont icon-zantingtingzhi";
						console.log(this.icon);
						this.v9.resume();
					}
				}
    ...
    .playback_snap_you{
        ...
        #videoPanel{
            ...
            .videoColor {
                ...
                .palace{
                    background-size: 10%;
					background: url('~@/assets/imgs/Heimdall_logo.png') no-repeat center center;
                    flex: 1 1 10%;
