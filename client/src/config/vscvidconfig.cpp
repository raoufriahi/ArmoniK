...
void VSCVidConf::SlotVidStorAdd()
{
	...
	m_pMainArea.addTab(pAdd,QIcon(tr(":/device/resources/addstor.png")), tr("SERVER ADD"));
...
void VSCVidConf::SlotVidEmapConf()
{
	...
	m_pMainArea.addTab(pConf,QIcon(tr(":/action/resources/map.png")), tr("MAP"));
	m_pMainArea.setCurrentWidget(pConf);
}
...
void VSCVidConf::SlotVidStorConf(std::string strStorId)
{
	...
	m_pMainArea.addTab(pConf,QIcon(tr(":/action/resources/control_panel.png")), tr("SERVER"));
	m_pMainArea.setCurrentWidget(pConf);	
}
